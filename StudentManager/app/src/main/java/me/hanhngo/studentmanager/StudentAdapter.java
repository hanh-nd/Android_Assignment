...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentViewHolder> {
    ...
    public StudentAdapter(ArrayList<StudentModel> studentModelArrayList) {
    ...
    public static class StudentViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(StudentModel studentModel) {
            ...
            binding.studentEmailTv.setText(studentModel.getEmail());
            binding.studentDobTv.setText(studentModel.getDob());
